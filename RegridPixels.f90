PROGRAM RegridPixels
        ...
        INTEGER :: temp_YEAR, temp_MONTH, temp_DAY, temp_ID, YYYY1, MM1, DD1
        REAL    :: temp_SZA, temp_CF, temp_AMF,VCD_Ori,VCD_Des
...
13      CONTINUE
        ...
        READ(In_Unit,"(4I8,13F15.6,4E15.6)",end=15,err=14) YYYY1,MM1,DD1, temp_ID,  &
                LAT(p,1:5), LON(p,1:5), temp_SZA, temp_CF, temp_AMF,         &
                VCD_Ori,VCD_Des,VCD_Unc(p), VCD(p)
        GOTO 13
14      CONTINUE
